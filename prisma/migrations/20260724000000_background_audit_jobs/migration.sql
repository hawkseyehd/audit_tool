...
-- CreateIndex
CREATE UNIQUE INDEX "AuditJob_scopeId_key" ON "AuditJob"("scopeId");

-- CreateIndex
CREATE INDEX "AuditJob_clientId_createdAt_idx" ON "AuditJob"("clientId", "createdAt");

-- CreateIndex
CREATE INDEX "AuditJob_state_createdAt_idx" ON "AuditJob"("state", "createdAt");

-- CreateIndex
CREATE INDEX "AuditJob_websiteId_createdAt_idx" ON "AuditJob"("websiteId", "createdAt");
