export const PAGE_SCHEMA_STATEMENTS = [
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS "WebsitePage_websiteId_normalizedUrl_key"
    ON "WebsitePage"("websiteId", "normalizedUrl")`,
  `CREATE INDEX IF NOT EXISTS "WebsitePage_websiteId_availability_lastObservedAt_idx"
    ON "WebsitePage"("websiteId", "availability", "lastObservedAt")`,
  `CREATE INDEX IF NOT EXISTS "WebsitePage_websiteId_pageType_idx"
    ON "WebsitePage"("websiteId", "pageType")`,
  `CREATE INDEX IF NOT EXISTS "WebsitePage_websiteId_changeState_idx"
    ON "WebsitePage"("websiteId", "changeState")`,
  `CREATE INDEX IF NOT EXISTS "WebsitePage_websiteId_selectionState_idx"
    ON "WebsitePage"("websiteId", "selectionState")`,
  `CREATE INDEX IF NOT EXISTS "DiscoveryRun_websiteId_startedAt_idx"
    ON "DiscoveryRun"("websiteId", "startedAt")`,
